                                    ...
                                    <tr class="inner-box">
                                        ...
                                        <td>
                                            <div class="event-wrap">
                                                <h3><a href="detail?no=<%= todo.getNo() %>"><%= todo.getTitle() %></a></h3>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="event-wrap">
                                        ...
                                        <td>
                                            <div class="primary-btn">
                                                <a class="btn btn-primary" href="modify?no=<%= todo.getNo() %>">수정</a>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="primary-btn">
                                                <a class="btn btn-primary" href="delete?no=<%= todo.getNo() %>">삭제</a>
                                            </div>
                                        </td>
                                    </tr>
                                   <%
